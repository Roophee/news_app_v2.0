...
const StyledNewsDate_Author = styled(Flex)`
    width: 100%;
`
    ...
    return (
        <StyledNewsItemWrapper className={'news__item'} justifyContent={'start'} alignItems={'flex-start'}>
            ...
            <div className={'news__content'}>
                ...
                <div>
                    <StyledNewsDate_Author className={'news__date_authors'} justifyContent={'space-between'}>
                        <div>
                        <span>
